  ...
  return (
    <div className='flex flex-row justify-around items-center pb-20'>
      <div className='flex flex-col '>
        ...
        <div className=''>© 2021 Blockfish Inc <br />
      ...
      <div className=''>
        ...
        <div className='mt-2 w-50 h-9 ' >
          <input className='w-full h-full rounded-md bg-black inp' type="text" value={userAddress} onChange={e => setUserAddress(e.target.value)} />
        </div>
        <div className='mt-2 w-20 h-9 '><button className='w-full h-full rounded-md cursor-pointer bg-black inp' onClick={addClick}>Submit</button></div>
